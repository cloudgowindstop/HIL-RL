...
def get_policy_class(name: str) -> PreTrainedPolicy:
    ...
    elif name == "diffusion_actor":
        from lerobot.policies.diffusion_actor.modeling_diffusion_actor import DiffusionActorPolicy

        return DiffusionActorPolicy
    elif name == "act":
    ...
    elif name == "hil-serl" or name == "sac":
...
def make_policy_config(policy_type: str, **kwargs) -> PreTrainedConfig:
    ...
    elif policy_type == "diffusion_actor":
        return DiffusionActorConfig(**kwargs)
    ...
    elif policy_type == "hil-serl" or policy_type == "sac":
