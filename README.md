...
This GitHub copy is **code + 2000-step offline-compare logs/results**. It does **not** include raw datasets, `*.pt` checkpoints, or the 19G optimizer dumps.

- Offline train code: [`cosmos_offline_train/`](cosmos_offline_train/)
- Writeup / plots: [`mingbo_result/README.md`](mingbo_result/README.md)
- Metrics, WandB logs, World RGB viz: [`offline_artifacts/README.md`](offline_artifacts/README.md)
