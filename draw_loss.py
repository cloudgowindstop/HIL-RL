...
# 读取数据
df = pd.read_csv(
    "/media/HIL-RL-Project/HIL-RL/experiments/close_trashbin_franka_1028/logs/cosmos_demo_l1_metrics.csv"
)
...
plt.savefig("demo_l1_loss_curve.png", dpi=300, bbox_inches="tight")
plt.show()
